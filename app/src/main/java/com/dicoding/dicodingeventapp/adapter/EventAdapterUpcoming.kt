...
class EventAdapterUpcoming(private var events: List<Event>, private val onItemClick: (Event) -> Unit) : RecyclerView.Adapter<EventAdapterUpcoming.EventViewHolder>() {
    ...
    class EventViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(event: Event, onItemClick: (Event) -> Unit) {
            eventName.text = event.name ?: "Unnamed Event" // Default jika nama kosong
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_home_upcoming, parent, false)
